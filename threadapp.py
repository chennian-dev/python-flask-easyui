...
def heartbeat():
	while True:
		...
		url="http://116.228.64.55:9093/IMEServer/applications/qsweb/Desktop.jsp"
		verVal = time.strftime('%Y%m%d', time.localtime(time.time()))
		data={"ver":verVal}
		req = requests.get(url,data,headers={'Cookie':'JSESSIONID=E92BD1159A4E6147968C9BEF084E30D5'})
